...
<head>
  ...
  <script src="../js/admin/reserved.js"></script>
...
<body>
    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Reserves</h1>
          <button class="btn btn-success" data-toggle="modal" data-target="#add-reserve" id="add-button">Reserve</button>
        </div>
      ...
      <div class="modal-content">
        ...
        <form id="add">
          <div class="modal-body">
            <label for="add_resort_id">Resort</label>
            <select class="form-control" name="resort_id" id="add_resort_id">
              <option value="">Astoria Resort</option>
              <option value="">Ricardo Resort</option>
            </select>
            ...
            <select class="form-control" name="account_id" id="add_account_id" required>
              <option value="">Account 1</option>
              <option value="">Account 2</option>
              <option value="">Account 3</option>
            </select>
            <label for="add_date_reserved">Reserve Date</label>
            <input type="date" name="date_reserved" id="add_date_reserved" class="form-control" required />
          </div>
  ...
  <div class="modal fade" id="edit-reserve" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form id="edit">
          <div class="modal-body">
            <label for="edit_reserve_id">Reserve ID</label>
            <input type="text" class="form-control" name="reserve_id" id="edit_reserve_id" disabled>
            <label for="edit_resort_id">Resort</label>
            <select class="form-control" name="resort_id" id="edit_resort_id">
              <option value="">Astoria Resort</option>
              <option value="">Ricardo Resort</option>
            </select>
            ...
            <label for="edit_date_reserved">Reserve Date</label>
            <input type="date" name="date_reserved" id="edit_date_reserved" class="form-control" required />
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
