    ...
    columns: [
      {
        ...
        render: function (data) {
          if (data.user_type == 'admin') {
            return '<button class="btn btn-warning edit-button" data-toggle="modal" data-target="#edit-room" data-room_id="'+data.room_id+'" data-room_name="'+data.room_name+'" data-room_description="'+data.room_description+'">Edit</button>'
          } else {
            return (
              '<button class="btn btn-warning edit-button" data-toggle="modal" data-target="#edit-room" data-room_id="'+data.room_id+'" data-room_name="'+data.room_name+'" data-room_description="'+data.room_description+'">Edit</button>' +
              '<button class="btn btn-danger delete-button" data-room_id="'+data.room_id+'">Delete</button>'
            )
          }
        },
      },
